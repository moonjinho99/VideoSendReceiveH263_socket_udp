...
{
    public sealed unsafe class H263VideoStreamEncoderCunsult : IDisposable
    {
        ...
        static H263VideoStreamEncoderCunsult()
        {
            ffmpeg.avcodec_register_all();
        }

        public H263VideoStreamEncoderCunsult(Stream stream, int fps, System.Drawing.Size frameSize)
        {
            _stream = stream;
